...
export class ChatManager {
    ...
    isNumericKeyedRecord(obj) {
        return obj && typeof obj === 'object' && !Array.isArray(obj) &&
            Object.keys(obj).every(k => !isNaN(Number(k)));
    }
    isNewStatsArrayLike(arr) {
        return Array.isArray(arr) &&
            Object.keys(arr).every(k => !isNaN(Number(k)) &&
    ...
    getPreviousMessage(currentIndex) {
    ...
    getMessageContext(messageIndex) {
        if (!this.isValidMessageForStats(messageIndex))
            return null;
