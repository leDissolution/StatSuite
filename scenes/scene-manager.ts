...
import type { ChatStatEntry } from "../chat/chat-stat-entry";
...
export class SceneManager {
    ...
    constructor(hooks?: { isPotentiallyMobile?: (baseKey: string) => boolean }) {
    ...
    getActiveScenes(messageId: number): string[] {
