...
import { StatEntry } from './stat-entry.js';
...
export class StatRegistry {
    ...
    getActiveStats(): StatEntry[] {
        return this.getAllStats().filter(stat => stat.isActive);
    }

    getActiveStatNames(): string[] {
